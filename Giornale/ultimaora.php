...
<head>
    ...
    <title>Sa Diri / Ultima ora</title>
        ...
        <div class="d-flex flex-wrap mr-auto justify-content-center">
            <?php
                ...
                while($record=mysqli_fetch_array($recordSet)){
                        ...
                        print'
                        <form method="get" action="Articolo.php" id="'.$id.'" style="cursor:pointer; width: 20em;">
                        <input style="display: none;" name="ide" value="'.$id.'">
                            <div class="card my-3" onClick="document.getElementById(\''.$id.'\').submit()">
