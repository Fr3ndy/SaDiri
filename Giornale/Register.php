...
<head>
    ...
    <title>Sa Diri / Registrazione</title>
...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container my-1 p-5 d-flex justify-content-center mt-auto">
        <form action="Gestione_Register.php" method="POST" class="border m-4 p-5 rounded-2 w-75">
            <h1 class="form-label">Registrazione</h1>
            <div class="mb-3 mt-3 ">
            ...
            <div class="mb-3">
                <label for="pwd" class="form-label">Ripeti Password:</label>
                <input type="password" class="form-control" id="pwd" placeholder="Enter password" name="pswd1">
                <label class="text-danger">
                    <?php
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="pwd" placeholder="Enter name" name="nome" value="<?php 
            ...
            <div class="mb-3">
                <label for="pwd" class="form-label">Cognome</label>
                <input type="text" class="form-control" id="pwd" placeholder="Enter surname" name="cognome" value="<?php 
                ...
                <label class="text-danger">
                    <?php
                        if(isset($_SESSION['E_cognome'])){
                        $N=$_SESSION["E_cognome"];
                        print"$N";
                        }
                    ?>
            ...
            <div class="mb-3 d-flex justify-content-between w-100">
                <button type="button" class="btn btn-secondary" onclick="location.href='Login.php'">Log-In</button>
