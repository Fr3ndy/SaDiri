...
<head>
    ...
    <title>Sa Diri / Admin-Categorie</title>
    ...
    <div class="d-flex" id="wrapper">
                ...
                <?php    
                        if(isset($_SESSION['logged']) && $_SESSION["grade"]==1){
                            print'<a class="list-group-item list-group-item-action p-3 my-1 " href="admin_articoli.php">Gestione Articoli</a>
                                    <a class="list-group-item list-group-item-action p-3 my-1 bg-dark text-light" href="admin_categorie.php">Gestione Categorie</a>
        ...
        <div id="page-content-wrapper" class="d-flex flex-column" style="height: 100vh;">
            ...
            <div class="container-fluid " style="overflow: auto; height: 88vh;">
                <h1 class="mt-4">Pagina Categorie</h1>
                <div class="my-5"></div>
                <form method="post" action="agg_categoria.php">
                    <h2>Aggiungi categoria</h2>
                    <input type="text" placeholder="Nome Categoria" name="nome_c">
                    <input type="number" placeholder="Importanza(1-100)" name="import" min="1" max="100" value="1">
                    <label class="text-danger">
                        <?php
                                if(isset($_SESSION['E_categoria'])){
                                $N=$_SESSION["E_categoria"];
                                print"$N";
                                }
                            ?>
                    </label>
                ...
                <table class="table table-striped">
                    ...
                    <?php   
                            ...
                            include ("Config.php");
                            $query = "
                            SELECT ID_CATEGORIA,NOME,IMPORTANZA
                            FROM categorie
                            ...
                            if ($ris)
                            {
                                print'
                                <tr>
                                <td>'.$array["ID_CATEGORIA"].'</td>
                                <td>'.$array["NOME"].'</td>
                                <td>'.$array["IMPORTANZA"].'</td>
                                <td><form action="" method="post">
                                <span name="ID" value="'.$array['ID_CATEGORIA'].'" style="display: none;"></span>
